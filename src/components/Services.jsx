  ...
  return (
    <>
      <section className="max-w-6xl mx-auto text-center flex  flex-col md:flex-row items-center  my-8 mb-16  px-4 gap-6">
        {/* cards 1 */}
        <div className="w-full h-56 md:w-1/3 p-5 flex flex-col gap-2 items-center justify-center  ">
          <div className="p-2 w-fit rounded-full border border-gray-400 bg-gray-300">
            <div className="p-2 rounded-full text-center w-fit bg-black">
              <svg
                width="41"
                height="40"
                viewBox="0 0 41 40"
              ...
              >
                <g clipPath="url(#clip0_1762_3517)">
                  <path
          ...
          <div className="p-2  w-fit rounded-full border border-gray-400 bg-gray-300">
            <div className="p-2 rounded-full text-center w-fit bg-black">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_1762_3534)">
                  <path
