...
const VendorSideBar = () => {
  ...
  return (
    <>
      ...
      />
      <aside
        className={`h-[calc(100vh-121px)] min-w-52 border-r max-md:border-b max-md:shadow-md pt-8  max-md:absolute top-0 bg-white transition-all duration-200 ease-in-out z-40 ${
        ...
        <nav className="w-40 mx-auto">
          <ul className="flex flex-col gap-3">
            {sideMenuItems.map((item) => (
              <li className="hover:bg-secondary2/10 transition-colors duration-100 rounded-sm">
                <Link
